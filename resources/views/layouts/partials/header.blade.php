                ...
                <ul class="nav navbar-nav" id="responsive-menu">
                    ...
                    @if(!Auth::guest())
                        <li>
                            ...
                            <ul>
                                <li><a href="{{url('/'.Auth::user()->role->name.'/'.Auth::user()->id.'/profile')}}"><i class="fa fa-user"></i> Profile</a></li>
                                <li><a data-toggle="modal" href="#switchModal"><i class="fa fa-refresh"></i> Switch account</a></li>
                                <li><a href="{{url('/create/resume')}}"><i class="fa fa-file-pdf-o"></i> Create a resume</a></li>
                                <li>
